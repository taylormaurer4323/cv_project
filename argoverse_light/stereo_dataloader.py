# -*- coding: utf-8 -*-
"""
Created on Thu Nov  3 19:23:11 2022
...
from argoverse_light.json_utils import read_json_file
...
class ArgoverseStereoDataLoader:
    ...
    def get_log_calibration_data(self, log_id: str) -> Mapping[str, Any]:
        ...
        """    
        os_specific_path = os.path.join(self.data_dir, 'rectified_stereo_images_v1.1',self.split_name,log_id, 'vehicle_calibration_stereo_info.json')
    ...
    def get_ordered_log_stereo_image_fpaths(self, log_id: str, camera_name: str) -> List[str]:
        ...
        """
        os_specific_path = os.path.join(self.data_dir, 'rectified_stereo_images_v1.1',self.split_name,log_id, camera_name, '*.jpg')
        stereo_img_fpaths = sorted(
            glob.glob(os_specific_path)    
        )
    ...
    def get_ordered_log_disparity_map_fpaths(self, log_id: str, disparity_name: str) -> List[str]:
        ...
        """
        os_specific_path = os.path.join(self.data_dir, 'disparity_maps_v1.1',self.split_name,log_id, disparity_name, '*.png')
